...
export class AdminService {
  ...
  static async setPlan(telegramId: number | bigint | string, plan: UserPlan, durationDays = 30): Promise<boolean> {
   ...
   */
  static async getUserDetails(telegramId: string | number | bigint) {
   ...
   */
  static async resetUserDailyUsage(telegramId: string | number | bigint): Promise<boolean> {
    const key = telegramId.toString();
   ...
   */
  static async updateUserPlan(telegramId: number | bigint | string, plan: UserPlan): Promise<boolean> {
    const key = telegramId.toString();
   ...
   */
  static async setUserBanStatus(telegramId: number | bigint | string, isBanned: boolean): Promise<boolean> {
    const key = telegramId.toString();
